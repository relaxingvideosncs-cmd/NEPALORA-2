...
export default function SiteSettingsAdminPage() {
  ...
  const [formData, setFormData] = useState<Partial<SiteSettingsRecord>>({
    brand_name: 'Nepalora',
    tagline: 'The Complete Guide to Nepal Travel, Trekking & Mindful Living',
    description:
    ...
    favicon_url: '',
    og_image_url: '',
    legal_business_name: 'Nepalora Media & Publishing',
    business_type: 'Editorial & Publishing',
    founded_year: 2026,
    email: 'editorial@nepalora.com',
    support_email: 'support@nepalora.com',
    phone: '',
    whatsapp: '',
    country: 'Nepal',
    ...
    postal_code: '44600',
    website_url: 'https://nepalora.com',
    facebook_url: '',
    instagram_url: 'https://instagram.com/nepalora',
    youtube_url: 'https://youtube.com/@nepalora',
    tiktok_url: '',
    linkedin_url: '',
    x_url: '',
    seo_title: 'Nepalora — Nepal Travel, Himalayan Trekking & Wellness Guides',
    seo_description:
