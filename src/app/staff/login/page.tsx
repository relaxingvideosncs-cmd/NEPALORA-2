...
export default function StaffLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      {/* Minimal top bar */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-hairline bg-bg-elevated/80 backdrop-blur-sm">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-semibold text-ink-secondary hover:text-ink transition-colors"
        >
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="p-6 sm:p-8 border border-hairline rounded-2xl sm:rounded-3xl shadow-md bg-bg-elevated">
            <div className="text-center mb-8">
              ...
              <p className="text-xs sm:text-sm text-ink-secondary mt-1">
                Nepalora editorial &amp; publishing dashboard
              </p>
            </div>
          ...
          <p className="text-center text-[11px] text-ink-tertiary mt-6">
            This portal is for authorised Nepalora editorial staff only.
          </p>
        </div>
      </div>
    </div>
